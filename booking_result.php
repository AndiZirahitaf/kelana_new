...
<body>
    ...
    <header class="absolute left-0 top-0 z-10 flex w-full items-center bg-transparent">
        <div class="container">
            <div class="relative flex items-center justify-between">
                <div class="px-4">
                    <a href="./index.php" class="block py-6 text-lg font-bold text-primary">kelana</a>
                </div>
    ...
    <section id="resultSec" class="pb-32 pt-36 dark:bg-slate-800">
        <div class="container">
            <div class="w-full px-4">
                <div class="mx-auto mb-16 max-w-xl text-center">
                    <h4 class="mb-2 text-lg font-semibold text-primary">Result</h4>
                    <h2 class="mb-4 text-3xl font-bold text-dark dark:text-white sm:text-4xl lg:text-5xl">
                        Form Pesanan Anda Terkirim!
                    </h2>
                    <h4 class="mb-10 text-lg text-secondary">Berikut adalah hasil pesanan anda.
                    </h4>
                    <a href="./riwayat_booking.php"
                        class="rounded-full bg-primary px-8 py-3 text-base font-semibold text-white transition duration-300 ease-in-out hover:opacity-80 hover:shadow-lg">Lihat
                        Riwayat Booking</a>
                </div>
            </div>
            ...
            <div class="flex flex-wrap justify-center">
                ...
                ?>
                <div class="w-full lg:mx-auto lg:w-2/3 px-4">
                    <div class=" bg-white shadow-lg dark:bg-slate-800 mb-10 overflow-hidden rounded-xl ">
                        <div class="bg-slate-200 p-5">
                            <p class=" font-bold text-lg"><?php echo $data['tgl_pesanan'];?></p>
                        </div>
